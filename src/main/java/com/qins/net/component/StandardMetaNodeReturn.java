...
import com.qins.net.meta.core.MetaNodeReturn;
import com.qins.net.util.SerializeUtil;

import java.lang.reflect.Field;

public class StandardMetaNodeReturn extends MetaNodeReturn {
    public Gson gson;
    public StandardMetaNodeReturn(Class<?> instanceClass) {
        super(instanceClass);
        if(sync){
    ...
    public Object deserialize(String instance) {
        ...
        return gson.fromJson(instance,proxyClass);
    }
