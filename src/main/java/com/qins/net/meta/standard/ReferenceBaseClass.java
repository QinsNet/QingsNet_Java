...
public class ReferenceBaseClass extends StandardBaseClass {
    public ReferenceBaseClass(String name,Class<?> instanceClass) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
